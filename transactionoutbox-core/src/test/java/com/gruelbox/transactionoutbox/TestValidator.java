...
class TestValidator {
    ...
    private static final Invocation COMPLEX_INVOCATION = new Invocation("Foo", "Bar", new Class<?>[]{int.class, BigDecimal.class, String.class}, new Object[]{1, BigDecimal.TEN, null});
    ...
    void testEntryDateInPast() {
        TransactionOutboxEntry entry = TransactionOutboxEntry.builder()
            .id("FOO")
