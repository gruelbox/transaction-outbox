 ...
 * API, this type introduces a number of useful blocking APIs which allow client-side code to
 * interact with the transaction manager in a more natural way.
 *
 * @param <CX> The type that the client code uses to interact with the transaction.
 * @param <TX> The transaction type.
 */
public interface JdbcTransactionManager<CX, TX extends JdbcTransaction<CX>>
