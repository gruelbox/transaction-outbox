...
@ApplicationScoped
public class QuarkusTransactionManager implements JdbcTransactionManager<CdiTransaction>, InitializationEventPublisher {
   ...
   public <T, E extends Exception> T inTransactionReturnsThrows(ThrowingTransactionalSupplier<T, E, CdiTransaction> work) throws E {
