...
class TestStubbingBlocking {
  ...
  void testStubbingWithExplicitContextPassingTransaction() {
    ...
    assertThat(Interface.invocations.get(0).get(1), isA(BaseTransaction.class));
  }
  ...
  private TransactionOutbox createOutbox(BaseTransactionManager transactionManager) {
  ...
  static class Interface {
    ...
    void doThing(int arg1, BaseTransaction transaction) {
