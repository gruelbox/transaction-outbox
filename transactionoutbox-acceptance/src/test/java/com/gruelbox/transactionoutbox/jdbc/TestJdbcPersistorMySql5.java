...
@Slf4j
@Testcontainers
class TestJdbcPersistorMySql5 extends AbstractPersistorTest<Connection, SimpleTransaction<Void>> {
  ...
  private JdbcPersistor persistor = JdbcPersistor.builder().dialect(Dialects.MY_SQL_5).build();
