...
class TestGuiceBinding {
  ...
  @Inject private JdbcTransactionManager<Void, SimpleTransaction<Void>> transactionManager;
  ...
  static final class DemoModule extends AbstractModule {
    ...
    @Provides
    @Singleton
    JdbcTransactionManager<Void, SimpleTransaction<Void>> manager() {
    ...
    TransactionOutbox outbox(
        Injector injector,
        JdbcTransactionManager<Void, SimpleTransaction<Void>> transactionManager) {
